...
## 7. Record Jira evidence

For Jira closure, capture evidence showing:

- The repository was created from the template
- The template repository setting is enabled on the template repository
- The new repository contains the governance files
- The ServiceNow initial commit succeeded
- The governance files and ServiceNow generated files coexist without conflict
